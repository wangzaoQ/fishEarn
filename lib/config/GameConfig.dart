...
class GameConfig {
  ...
  // ====== 道具/危险事件 ======
  // 漂流瓶进度时间 (正式 5*60)
  static const bottleDuration = 2*10;
  // ====== 道具/危险事件 ======
  // 第一个危险出现时间 (正式 3*60)
  static const gameDangerTime1 = 2 * 60;
  // 第二个危险出现时间 (正式 8*60)
  static const gameDangerTime2 = 3 * 60;
  // 第三个危险出现时间 (正式 11*60)
  static const gameDangerTime3 = 4 * 60;
  // ====== task默认 ======
