...
class ADFailPop extends StatefulWidget {
  ...
  @override
  State<ADFailPop> createState() => _ADFailPopState();
}

class _ADFailPopState extends State<ADFailPop> {

  @override
  void initState() {
    super.initState();
    EventManager.instance.postEvent(EventConfig.ad_fail);
  }
        ...
        children: [
          Column(
            ...
            children: [
              ...
              Image.asset("assets/images/ic_ad_fail.webp",width: 196.w,height:190.h,fit: BoxFit.fill,),
              /// 确认按钮
              CupertinoButton(
                ...
                onPressed: () {
                  EventManager.instance.postEvent(EventConfig.ad_fail_c);
                  Navigator.pop(context,1);
                },
              ),
